...
# data config
args_dict['task_name'] = 'covid19_kaggle_train_cv_5_2'
args_dict[
    'cls_model_folder'] = '../classification/work_dir/covid19_kaggle_train_cv_5_2_run1'
...
args_dict[
    'fine_tune_model_file'] = 'work_dir/pneumonia_RSNA_run1/model_best.pth'
